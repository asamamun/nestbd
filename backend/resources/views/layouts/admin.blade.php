...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/svg+xml" href="{{asset('admin/assets')}}/assets/icons/favicon.svg">
    <link rel="icon" type="image/png" href="{{asset('admin/assets')}}/assets/icons/favicon.png">
    ...
    <!-- Title -->
    <title>Admin Dashboard - Modern Bootstrap Admin</title>
    
    <!-- Theme Color -->
    <meta name="theme-color" content="#6366f1">
    
    <!-- PWA Manifest -->
    <link rel="manifest" href="{{asset('admin/assets/')}}/manifest-DTaoG9pG.json">
  <script type="module" crossorigin src="{{asset('admin/assets/')}}/rolldown-runtime-CrqDHxfU.js"></script>
  <script type="module" crossorigin src="{{asset('admin/assets/')}}/vendor-bootstrap-BTj7Ss1X.js"></script>
  <script type="module" crossorigin src="{{asset('admin/assets/')}}/vendor-ui-BQHoO1Qu.js"></script>
  <script type="module" crossorigin src="{{asset('admin/assets/')}}/vendor-charts-DajHsbsu.js"></script>
  <script type="module" crossorigin src="{{asset('admin/assets/')}}/constants-DwCw-lc0.js"></script>
  <script type="module" crossorigin src="{{asset('admin/assets/')}}/main-Dv8VWJXt.js"></script>
  <link rel="stylesheet" crossorigin href="{{asset('admin/assets/')}}/main-Ce55AM6k.css">
</head>
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white border-bottom">
                <div class="container-fluid">
                    ...
                    <a class="navbar-brand d-flex align-items-center" href="./index.html">
                        <img src="{{asset('admin/')}}/assets/images/logo.svg" alt="Logo" height="32" class="d-inline-block align-text-top me-2">
                    ...
                    <div class="navbar-nav flex-row">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-outline-secondary d-flex align-items-center" 
                                    ...
                                    data-bs-toggle="dropdown" 
                                    aria-expanded="false">
                                <img src="{{asset('admin/')}}/assets/images/avatar-placeholder.svg" 
                                     alt="User Avatar" 
                                     width="24" 
                                     height="24" 
        ...
        <main id="main-content" class="admin-main">
            <div class="container-fluid p-4 p-lg-4">
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3 mb-4">
                    <div>
                        <h1 class="h3 mb-0">Admin Dashboard- main. Role {{Auth::user()->role}}</h1>
